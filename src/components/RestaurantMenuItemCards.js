...
const RestaurantMenuItemCards = ({ menuType }) => {
  ...
  return (
    <div className="w-[850px] max-w-[90%] mx-auto my-6 flex  flex-col">
      <div
        className="bg-blue-300 flex justify-between items-center"
      ...
      {menuType?.card?.card?.itemCards.map((item) => {
        return (
          <div
            ...
            className={` ${accordianOpen ? "flex" : "hidden"} w-full gap-4`}
          >
            <div>
            ...
            <div className="w-full flex flex-col">
              ...
              />
              <button class="bg-green-400 px-4 py-2 m-4 rounded-md text-white hover:bg-green-600 ">
                ADD
              </button>
              <div className="m-4 flex items-center  bg-white justify-center rounded-md shadow-lg">
