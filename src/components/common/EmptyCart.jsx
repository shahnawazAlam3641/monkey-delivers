...
const EmptyCart = () => {
  return (
    <div className="flex flex-col justify-center items-center m-auto gap-4 max-w-[85%]">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        id="empty-cart"
        viewBox="0 0 650 512"
        className="w-[350px] max-w-[85%] "
      >
      ...
      <Link to={"/search"}>
        <button className="p-2 bg-orange-500 rounded-sm text-white font-bold hover:scale-95 transition-all duration-200">
