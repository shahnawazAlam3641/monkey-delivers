...
const RestaurantChains = ({cuisine}) => {
  ...
  return (
    <div className='flex max-w-[80%] mx-auto gap-4'>{
  ...
  return (
    ...
    <div className='flex flex-col'>
        ...
        <p className='flex items-center gap-1 font-semibold'><svg
    width={20}
    height={20}
    viewBox="0 0 20 20"
    fill="none"
  ...
  </svg>{avgRating} • {slaString}</p>
        <p className='text-[#00000085] text-ellipsis'>{cuisines.join(", ")}</p>
